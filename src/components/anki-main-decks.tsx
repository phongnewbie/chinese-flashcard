        ...
        <table className="anki-deck-table">
          <thead>
            <tr>
              ...
              <th className="anki-deck-stat-col" title="Thẻ mới">Mới</th>
              <th className="anki-deck-stat-col" title="Đang học">Học</th>
              <th className="anki-deck-stat-col" title="Đến hạn ôn">Ôn</th>
